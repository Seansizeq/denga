...
const remoteDeploy = async (expectedSha) => {
  ...
  const script = [
    ...
    'if ! grep -q "^BYBIT_CREDENTIALS_KEY=" .env 2>/dev/null; then',
    '  printf "\\nBYBIT_CREDENTIALS_KEY=%s\\nBYBIT_SYNC_INTERVAL_MS=60000\\n" "$(openssl rand -base64 32 | tr -d "\\n")" >> .env',
    '  echo "[server] Generated Bybit credential encryption key."',
    'fi',
