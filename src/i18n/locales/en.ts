...
const dictionary: Dict = {
  ...
  planner: {
    ...
    salaryRate: 'Hourly rate',
    salaryAmount: 'Amount for this shift',
    note: 'Note',
    ...
    shiftModeHours: 'By hours',
    shiftDurationInvalid: 'Start and end must differ',
    shiftOvernightHint: ' · an end before the start means an overnight shift',
    templateNew: 'New template',
    templateAdd: 'New',
    templateEdit: 'Shift template',
    templatesEmpty: 'No templates yet. Create the first one and a shift becomes a single tap.',
    templatesHint: 'A template fills the time, rate and name of a new shift. Edit it here — shifts already recorded from it stay as they are.',
    templateDefaultTag: 'Default',
    templateExists: 'That template already exists — change the name, symbol or currency.',
    manageTemplates: 'Shift templates',
    startShiftNow: 'Starts now, whatever day is selected',
    saveAsTemplate: 'Save as template',
  },
  subscriptions: {
    title: 'Subscriptions',
