...
const dictionary: Dict = {
  ...
  addTx: {
    ...
    chargedFromAccount: 'З рахунку спишеться',
    creditedToAccount: 'На рахунок зарахується',
  ...
  planner: {
    ...
    salaryRate: 'Ставка за годину',
    salaryAmount: 'Сума за зміну',
    note: 'Нотатка',
    ...
    shiftModeHours: 'Годинами',
    shiftDurationInvalid: 'Вкажіть різні початок і кінець зміни',
    shiftOvernightHint: ' · кінець раніше за початок означає нічну зміну',
    templateNew: 'Новий шаблон',
    templateAdd: 'Новий',
    templateEdit: 'Шаблон зміни',
    templatesEmpty: 'Шаблонів ще немає. Створіть перший — і зміну можна буде додати одним дотиком.',
    templatesHint: 'Шаблон підставляє час, ставку й назву в нову зміну. Змінюйте його тут — зміни, вже записані з нього, лишаються як є.',
    templateDefaultTag: 'За умовчанням',
    templateExists: 'Такий шаблон уже є — змініть назву, символ або валюту.',
    manageTemplates: 'Шаблони змін',
    startShiftNow: 'Почнеться зараз, незалежно від обраного дня',
    saveAsTemplate: 'Зберегти як шаблон',
  },
  subscriptions: {
    title: 'Підписки',
  ...
  settings: {
    ...
    currencyDescription:
      'У ній показуються суми. У ній же рахуються записи з бота й ярлика, коли валюту не вказано.',
    currencyUah: 'Гривня (₴)',
    currencyPln: 'Злотий (zł)',
    currencyUsd: 'Долар ($)',
    ...
    automationExpenseDescription:
      'Ярлик на телефоні бере за посиланнями ваші категорії, рахунки та валюти, а останнім зберігає витрату. Списки тягнуться щоразу, тож нову категорію чи рахунок не треба вписувати в ярлик руками.',
    automationCategoriesUrl: 'Посилання: список категорій',
    automationAccountsUrl: 'Посилання: список рахунків',
    automationCurrenciesUrl: 'Посилання: список валют',
    automationTransactionUrl: 'Посилання: додати витрату',
    automationExpenseHowTo:
      'iOS, на кожен список: «Отримати вміст URL» з посиланням → одразу «Вибрати зі списку». Далі «Отримати вміст URL» з останнім посиланням, метод POST, тіло JSON: amount (число з «Запитати ввід»), categoryId і account — просто обрані рядки зі списків.',
    automationExpenseHowToCurrency:
      'Поле currency необовʼязкове: без нього сума рахується у валюті за замовчуванням із налаштувань. Додайте список валют у ярлик — і можна платити злотими з гривневої картки: сума спишеться за курсом дня.',
    ...
    automationWalletTitle: 'Оплата карткою через Apple Pay',
    automationWalletDescription:
      'Автоматизація спрацьовує сама, щойно ви прикладаєте телефон до терміналу: суму й назву магазину передає Wallet, категорію застосунок вгадує, а бот надсилає картку — виправити одним дотиком. Виправлену категорію він запамʼятовує для цього магазину.',
    automationWalletHowTo:
      'iOS: Команди → Автоматизація → Нова → «Гаманець» (у старіших версіях «Транзакція») → оберіть картку → «Запускати одразу». Дії: «Знайти збіг у тексті» з-поміж Transaction Amount за виразом [0-9.,]+ → «Отримати вміст URL» з посиланням, метод POST, тіло JSON.',
    automationWalletHowToCard:
      'Поля JSON: amount — знайдене число, currency — валюта картки (UAH, PLN або USD), merchant — Transaction Name, account — ключ вашого рахунку. Категорію не передавайте: саме тоді прилітає картка з виправленням.',
    automationWalletLimits:
      'Ловить лише дотики карткою в магазині. Оплати в застосунках і в браузері Apple не передає — їх додайте вручну або привʼяжіть картку банку вище.',
    bankTitle: 'Картка банку',
    bankDescription:
      'Привʼязана картка записує операції сама — і покупки в магазині, і онлайн, і підписки. Бот надсилає картку з вгаданою категорією, щоб виправити її одним дотиком.',
    bankWritesTo: 'Записує в',
    bankTokenLabel: 'Персональний токен monobank',
    bankTokenPlaceholder: 'u_XXXXXXXXXXXXXXXXXXXXXX',
    bankTokenHint:
      'Відкрийте api.monobank.ua з телефона, увійдіть через застосунок monobank і скопіюйте токен. Він дає доступ лише на читання виписки.',
    bankLoadAccounts: 'Показати картки',
    bankChooseAccount: 'Яку картку підключити',
    bankChooseWallet: 'Куди записувати операції',
    bankConnect: 'Підключити',
    bankConnected: 'Картку підключено',
    bankDisconnect: 'Відключити',
    bankUnsupportedCurrency: 'Валюта не підтримується',
    bankNoWalletAccount:
      'Немає рахунку в цій валюті. Створіть його на екрані «Рахунки» — саме туди підуть операції.',
    bankHowTo:
      'Якщо на цю саму картку налаштована й автоматизація Apple Pay, вимкніть одне з двох: інакше кожна покупка запишеться двічі.',
